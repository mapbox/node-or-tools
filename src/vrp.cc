...
VRP::VRP(CostMatrix costs_, DurationMatrix durations_, TimeWindows timeWindows_, DemandMatrix demands_)
    : costs{std::make_shared<const CostMatrix>(std::move(costs_))}, durations{std::make_shared<const DurationMatrix>(
                                                                        std::move(durations_))},
      timeWindows{std::make_shared<const TimeWindows>(std::move(timeWindows_))}, demands{std::make_shared<const DemandMatrix>(
                                                                                     std::move(demands_))} {}
